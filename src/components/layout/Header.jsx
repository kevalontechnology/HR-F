...
import { Bell, User, LogOut, Key, Building2, CheckCircle } from 'lucide-react';
...
export const Header = () => {
  ...
  return (
    <header className="bg-erp-primary text-white h-14 flex items-center justify-between px-4 shadow-sm z-30 sticky top-0">
      {/* Brand & ERP Title */}
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-bold text-base tracking-wider uppercase leading-tight">
            Kevalon Technology
          </h1>
          <p className="text-[10px] text-gray-200 tracking-widest font-semibold uppercase">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 bg-white text-gray-800 border border-erp-border rounded-xs shadow-xl z-50 overflow-hidden">
        ...
        <button
          onClick={logout}
          className="bg-red-700 hover:bg-red-800 text-white px-2.5 py-1 rounded-xs text-xs font-bold flex items-center gap-1 transition"
          title="Logout"
        >
          <LogOut size={14} />
